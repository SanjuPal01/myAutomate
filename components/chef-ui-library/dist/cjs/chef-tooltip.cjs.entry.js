 ...
 */
var now = function() {
  return __chunk_3.root.Date.now();
};
...
function debounce(func, wait, options) {
  ...
  wait = __chunk_3.toNumber(wait) || 0;
  if (__chunk_3.isObject(options)) {
    leading = !!options.leading;
    maxing = 'maxWait' in options;
    maxWait = maxing ? nativeMax(__chunk_3.toNumber(options.maxWait) || 0, wait) : maxWait;
...
var func = __chunk_3.convert('debounce', debounce_1);
...
class ChefTooltip {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: classNames, style: styles }, __chunk_1.h("slot", null)));
    }
...
exports.chef_tooltip = ChefTooltip;
