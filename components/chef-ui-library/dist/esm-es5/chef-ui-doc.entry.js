...
var ChefUIDoc = /** @class */ (function () {
    function ChefUIDoc(hostRef) {
        registerInstance(this, hostRef);
    }
    ChefUIDoc.prototype.render = function () {
        return [
    ...
    ChefUIDoc.prototype.summary = function (doc) {
    ...
    ChefUIDoc.prototype.description = function (doc) {
        var text = getOr('No Description', 'description', doc);
        return (h("div", { class: "description" }, h("h3", null, "Description"), h("chef-markdown", { text: text })));
    };
    ChefUIDoc.prototype.properties = function (doc) {
        ...
        var propertyList = pipe(getOr([], 'properties'), map(propRow))(doc);
