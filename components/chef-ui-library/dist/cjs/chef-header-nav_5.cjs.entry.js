...
const __chunk_2 = require('./chunk-f5b13333.js');
const __chunk_3 = require('./chunk-ebd2af7c.js');
...
const __chunk_7 = require('./chunk-1f0c4357.js');
const __chunk_8 = require('./chunk-4ac11d91.js');
require('./chunk-3cd57471.js');
const __chunk_10 = require('./chunk-03a2c97f.js');
require('./chunk-30b31332.js');
const __chunk_12 = require('./chunk-949655a8.js');
...
class ChefHeaderNav {
    ...
    render() {
        return (__chunk_1.h("header", { role: "banner" }, __chunk_1.h("nav", { "aria-labelledby": "nav1", class: "navigation-wrapper" }, __chunk_1.h("div", { class: "left-nav", role: "menubar" }, __chunk_1.h("stencil-route-link", { role: "menuitem", class: "logo-link", title: "Chef UI Library Home Link ReadMe", url: "/" }, __chunk_1.h("h2", null, "Chef UI Library")), __chunk_1.h("div", { class: "navigation-menu" }, __chunk_1.h("h2", { id: "nav1", class: "visually-hidden" }, "Main Header Navigation for UI Library"), __chunk_1.h("stencil-route-link", { role: "menuitem", class: "nav-link", tabindex: "0", url: "/design" }, "Design Elements"), __chunk_1.h("stencil-route-link", { role: "menuitem", class: "nav-link", tabindex: "0", url: "/atoms" }, "Atoms"), __chunk_1.h("stencil-route-link", { role: "menuitem", class: "nav-link", tabindex: "0", url: "/molecules" }, "Molecules"), __chunk_1.h("stencil-route-link", { role: "menuitem", class: "nav-link", tabindex: "0", url: "/templates" }, "Templates"), __chunk_1.h("stencil-route-link", { role: "menuitem", class: "nav-link", tabindex: "0", url: "/charts" }, "Charts"))))));
    }
    static get style() { return "chef-header-nav{display:block;position:fixed;z-index:100;top:0;left:0;right:0;background-color:var(--chef-white);-webkit-box-shadow:var(--chef-box-shadow);box-shadow:var(--chef-box-shadow)}chef-header-nav .navigation-wrapper{display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between}chef-header-nav .navigation-wrapper .left-nav{display:-ms-flexbox;display:flex}chef-header-nav .navigation-wrapper .navigation-menu{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}chef-header-nav .navigation-wrapper .logo-link,chef-header-nav .navigation-wrapper .nav-link{margin:10px 1em}chef-header-nav .navigation-wrapper .logo-link a,chef-header-nav .navigation-wrapper .nav-link a{color:var(--chef-primary-dark);text-decoration:none}chef-header-nav .navigation-wrapper .logo-link a:hover,chef-header-nav .navigation-wrapper .nav-link a:hover{color:var(--chef-primary-bright)}chef-header-nav .navigation-wrapper .logo-link a{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;white-space:nowrap;text-decoration:none}chef-header-nav .navigation-wrapper .logo-link a:before{content:\"\";display:block;width:50px;height:50px;margin-right:1em;background:url(/assets/code-book.svg);background-size:contain}chef-header-nav .navigation-wrapper .logo-link a h2{margin:0}chef-header-nav .navigation-wrapper .nav-link a{padding-bottom:20px}chef-header-nav .navigation-wrapper .nav-link a.active,chef-header-nav .navigation-wrapper .nav-link a:focus,chef-header-nav .navigation-wrapper .nav-link a:hover{color:var(--chef-primary-bright);border-bottom:2px solid var(--chef-primary-bright)}"; }
}
...
var developmentOnly = __chunk_2.createCommonjsModule(function (module, exports) {
...
__chunk_2.unwrapExports(developmentOnly);
...
function baseSet(object, path, value, customizer) {
  ...
  path = __chunk_3.castPath(path, object);
  ...
  while (nested != null && ++index < length) {
    var key = __chunk_3.toKey(path[index]),
        newValue = value;
    ...
    if (index != lastIndex) {
      ...
      if (newValue === undefined) {
        newValue = __chunk_3.isObject(objValue)
          ? objValue
          : (__chunk_3.isIndex(path[index + 1]) ? [] : {});
      }
    }
    __chunk_3.assignValue(nested, key, newValue);
    nested = nested[key];
  }
  return object;
}
...
var func = __chunk_3.convert('set', set_1);
...
const GET_DOCS = 'DOCS::GET';
const GET_DOCS_SUCCESS = 'DOCS::GET::SUCCESS';
const GET_DOCS_FAILED = 'DOCS::GET::FAILED';
...
function replace() {
  var args = arguments,
      string = __chunk_3.toString(args[0]);
...
var func$1 = __chunk_3.convert('replace', replace_1);
...
function charsEndIndex(strSymbols, chrSymbols) {
  ...
  while (index-- && __chunk_3.baseIndexOf(chrSymbols, strSymbols[index], 0) > -1) {}
  return index;
}
...
function charsStartIndex(strSymbols, chrSymbols) {
  ...
  while (++index < length && __chunk_3.baseIndexOf(chrSymbols, strSymbols[index], 0) > -1) {}
  return index;
}
...
function trim(string, chars, guard) {
  string = __chunk_3.toString(string);
  if (string && (guard || chars === undefined)) {
    return __chunk_3.baseTrim(string);
  }
  if (!string || !(chars = __chunk_3.baseToString(chars))) {
    return string;
  }
  var strSymbols = __chunk_6.stringToArray(string),
      chrSymbols = __chunk_6.stringToArray(chars),
      start = _charsStartIndex(strSymbols, chrSymbols),
      end = _charsEndIndex(strSymbols, chrSymbols) + 1;

  return __chunk_6.castSlice(strSymbols, start, end).join('');
}

var trim_1 = trim;

var func$2 = __chunk_3.convert('trim', trim_1);
...
function baseIsRegExp(value) {
  return __chunk_3.isObjectLike(value) && __chunk_3.baseGetTag(value) == regexpTag;
}

var _baseIsRegExp = baseIsRegExp;

/* Node.js helper references. */
var nodeIsRegExp = __chunk_3.nodeUtil && __chunk_3.nodeUtil.isRegExp;
 ...
 * // => false
 */
var isRegExp = nodeIsRegExp ? __chunk_3.baseUnary(nodeIsRegExp) : _baseIsRegExp;
...
function split(string, separator, limit) {
  if (limit && typeof limit != 'number' && __chunk_10.isIterateeCall(string, separator, limit)) {
  ...
  if (string && (
    ...
    separator = __chunk_3.baseToString(separator);
    if (!separator && __chunk_6.hasUnicode(string)) {
      return __chunk_6.castSlice(__chunk_6.stringToArray(string), 0, limit);
    }
  }
...
var func$3 = __chunk_3.convert('split', split_1);

func$3.placeholder = __chunk_3.require$$1;
var split$1 = func$3;

const getTagList = __chunk_8.getOr([], ['comment', 'tags']);
const getTagText = __chunk_5.pipe(__chunk_5.get('text'), trim$1);
/**
 * @param name  The tag name to search for.
 * @param json  The json object to search through.
 * @returns     The text for the first matching tag.
 */
const findTag = (name, json) => __chunk_5.pipe(getTagList, __chunk_7.find(['tag', name]), getTagText)(json);
/**
 * @param name  The tag name to search for.
 * @param json  The json object to search through.
 * @returns     A list containing the text for each matching tag.
 */
const filterTags = (name, json) => __chunk_5.pipe(getTagList, __chunk_6.filter(['tag', name]), __chunk_4.map(getTagText))(json);
const getDecorators = __chunk_8.getOr([], 'decorators');
const parseObjectString = __chunk_5.pipe(replace$1(/(\w+):/ig, '"$1":'), replace$1(/'/ig, '"'), (s) => s ? JSON.parse(s) : {});
/**
 * @param json The json object to extract metadata from.
 * @returns    An object containing the components metadata.
 */
const getComponentMetaData = __chunk_5.pipe(getDecorators, __chunk_7.find(['name', 'Component']), __chunk_8.getOr('', ['arguments', 'opts']), parseObjectString);
function getComponentProps(children) {
    ...
    const properties = __chunk_6.filter(filterer, children);
    return __chunk_4.map((prop) => {
        return {
            name: prop['name'],
            description: __chunk_8.getOr('', ['comment', 'shortText'], prop),
 ...
 */
const getType = __chunk_5.pipe(__chunk_5.get(['sources', 0, 'fileName']), split$1('/'), __chunk_6.first);
...
function reduce(collection, iteratee, accumulator) {
  var func = __chunk_3.isArray(collection) ? __chunk_6.arrayReduce : _baseReduce,
      initAccum = arguments.length < 3;

  return func(collection, __chunk_3.baseIteratee(iteratee), accumulator, initAccum, __chunk_4.baseEach);
}

var reduce_1 = reduce;

var func$4 = __chunk_3.convert('reduce', reduce_1);

func$4.placeholder = __chunk_3.require$$1;
var reduce$1 = func$4;

const indexer = (transform) => __chunk_5.pipe(__chunk_4.map(transform), reduce$1((acc, entity) => set$1(entity.id, entity, acc), {}));
...
function docReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case GET_DOCS_SUCCESS:
            ...
            return __chunk_5.pipe(set$1('status', Status.loadSuccess), set$1('byId', docs), set$1('allIds', __chunk_4.map('id', docs)))(state);
        default:
            return state;
    }
}
...
const configureStore = (initialState) => createStore(rootReducer, initialState, developmentOnly_1(applyMiddleware(thunk)));

class ChefLibraryApp {
    constructor(hostRef) {
        __chunk_1.registerInstance(this, hostRef);
    ...
    render() {
        return (__chunk_1.h("div", null, __chunk_1.h("chef-header-nav", null), __chunk_1.h("stencil-router", null, __chunk_1.h("stencil-route", { url: "/", component: "chef-read-me", exact: true }), __chunk_1.h("stencil-route", { url: ['/design/:id', '/design'], componentProps: { docType: 'design' }, component: "chef-design-docs" }), __chunk_1.h("stencil-route", { url: ['/atoms/:id', '/atoms'], componentProps: { docType: 'atoms' }, component: "chef-ui-docs" }), __chunk_1.h("stencil-route", { url: ['/molecules/:id', '/molecules'], componentProps: { docType: 'molecules' }, component: "chef-ui-docs" }), __chunk_1.h("stencil-route", { url: ['/templates/:id', '/templates'], componentProps: { docType: 'templates' }, component: "chef-ui-docs" }), __chunk_1.h("stencil-route", { url: ['/charts/:id', '/charts'], componentProps: { docType: 'charts' }, component: "chef-ui-docs" }))));
    }
}
...
class Route {
    ...
    computeMatch(newLocation) {
        ...
        return this.match = __chunk_12.matchPath(newLocation.pathname, {
            path: this.url,
            exact: this.exact,
            strict: true
        });
    ...
    async loadCompleted() {
        ...
        else if (this.match && !__chunk_12.matchesAreEqual(this.match, this.previousMatch) && this.routeViewsUpdated) {
...
__chunk_13.ActiveRouter.injectProps(Route, [
    'location',
    'history',
    'historyType',
    'routeViewsUpdated'
...
class RouteLink {
    ...
    computeMatch() {
        if (this.location) {
            this.match = __chunk_12.matchPath(this.location.pathname, {
...
__chunk_13.ActiveRouter.injectProps(RouteLink, [
    'history',
    'location',
    'root'
]);
...
const createBrowserHistory = (win, props = {}) => {
    ...
    const basename = props.basename ? __chunk_12.stripTrailingSlash(__chunk_12.addLeadingSlash(props.basename)) : '';
    ...
    const getDOMLocation = (historyState) => {
        ...
        warning((!basename || __chunk_12.hasBasename(path, basename)), 'You are attempting to use a basename on a page whose URL path does not begin ' +
            'with the basename. Expected path "' + path + '" to begin with "' + basename + '".');
        if (basename) {
            path = __chunk_12.stripBasename(path, basename);
        }
        return __chunk_12.createLocation(path, state, key || __chunk_12.createKey(keyLength));
    };
    ...
    const createHref = (location) => {
        return basename + __chunk_12.createPath(location);
    };
    const push = (path, state) => {
        warning(!(typeof path === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' +
            'argument is a location-like object that already has state; it is ignored');
        const action = 'PUSH';
        const location = __chunk_12.createLocation(path, state, __chunk_12.createKey(keyLength), history.location);
        transitionManager.confirmTransitionTo(location, action, getUserConfirmation, (ok) => {
            if (!ok) {
                return;
            }
...
const HashPathCoders = {
    hashbang: {
        encodePath: (path) => path.charAt(0) === '!' ? path : '!/' + __chunk_12.stripLeadingSlash(path),
        decodePath: (path) => path.charAt(0) === '!' ? path.substr(1) : path
    },
    noslash: {
        encodePath: __chunk_12.stripLeadingSlash,
        decodePath: __chunk_12.addLeadingSlash
    },
    slash: {
        encodePath: __chunk_12.addLeadingSlash,
        decodePath: __chunk_12.addLeadingSlash
    }
};
const createHashHistory = (win, props = {}) => {
    ...
    const getDOMLocation = () => {
        ...
        return __chunk_12.createLocation(path, undefined, __chunk_12.createKey(keyLength));
    };
    const transitionManager = createTransitionManager();
    const setState = (nextState) => {
        Object.assign(history, nextState);
    ...
    const handleHashChange = () => {
        ...
        if (path !== encodedPath) {
            ...
            if (!forceNextPop && __chunk_12.locationsAreEqual(prevLocation, location)) {
                return; // A hashchange doesn't always == location change.
            }
            if (ignorePath === __chunk_12.createPath(location)) {
    ...
    const revertPop = (fromLocation) => {
        ...
        let toIndex = allPaths.lastIndexOf(__chunk_12.createPath(toLocation));
        let fromIndex = allPaths.lastIndexOf(__chunk_12.createPath(fromLocation));
        if (toIndex === -1) {
            toIndex = 0;
        }
        if (fromIndex === -1) {
    ...
    let allPaths = [__chunk_12.createPath(initialLocation)];
    // Public interface
    const createHref = (location) => ('#' + encodePath(basename + __chunk_12.createPath(location)));
    const push = (path, state) => {
        warning(state === undefined, 'Hash history cannot push state; it is ignored');
        const action = 'PUSH';
        const location = __chunk_12.createLocation(path, undefined, __chunk_12.createKey(keyLength), history.location);
        transitionManager.confirmTransitionTo(location, action, getUserConfirmation, (ok) => {
            if (!ok) {
                return;
            }
            const path = __chunk_12.createPath(location);
            ...
            if (hashChanged) {
                ...
                const prevIndex = allPaths.lastIndexOf(__chunk_12.createPath(history.location));
    ...
    const replace = (path, state) => {
        ...
        transitionManager.confirmTransitionTo(location, action, getUserConfirmation, (ok) => {
            ...
            const prevIndex = allPaths.indexOf(__chunk_12.createPath(history.location));
            if (prevIndex !== -1) {
...
class Router {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_13.ActiveRouter.Provider, { state: state }, __chunk_1.h("slot", null)));
    }
    get el() { return __chunk_1.getElement(this); }
}

exports.chef_header_nav = ChefHeaderNav;
exports.chef_library_app = ChefLibraryApp;
